  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute -top-24 -left-24 w-64 h-64 sm:w-[28rem] sm:h-[28rem] bg-white/12 rounded-full blur-3xl animate-float [animation-duration:9s]" />
        <div className="absolute -bottom-24 -right-24 w-72 h-72 sm:w-[32rem] sm:h-[32rem] bg-white/9 rounded-full blur-3xl animate-float animation-delay-400 [animation-duration:10s]" />
        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center min-h-0 lg:min-h-[80vh]">
          ...
          <div className="relative animate-fade-in animation-delay-600 order-first lg:order-none mt-4 sm:mt-8 lg:mt-0">
            <div className="grid grid-cols-2 gap-3 sm:gap-4 lg:gap-6 max-w-md mx-auto lg:max-w-none">
              {/* Card 1 */}
              <div className="product-card relative overflow-hidden bg-white/10 text-white p-4 sm:p-6 animate-float [animation-duration:10s] rounded-2xl border border-white/22 shadow-[0_16px_60px_rgba(0,0,0,0.26)] hover:shadow-[0_26px_90px_rgba(0,0,0,0.34)] transition-all duration-200 hover:-translate-y-1 backdrop-blur-md">
              ...
              {/* Card 3 */}
              <div className="product-card relative overflow-hidden bg-white/10 text-white p-4 sm:p-6 animate-float animation-delay-400 [animation-duration:12s] -mt-2 sm:-mt-4 rounded-2xl border border-white/22 shadow-[0_16px_60px_rgba(0,0,0,0.26)] hover:shadow-[0_26px_90px_rgba(0,0,0,0.34)] transition-all duration-200 hover:-translate-y-1 backdrop-blur-md">
              ...
              {/* Card 4 */}
              <div className="product-card relative overflow-hidden bg-white/10 text-white p-4 sm:p-6 animate-float animation-delay-600 [animation-duration:11s] rounded-2xl border border-white/22 shadow-[0_16px_60px_rgba(0,0,0,0.26)] hover:shadow-[0_26px_90px_rgba(0,0,0,0.34)] transition-all duration-200 hover:-translate-y-1 backdrop-blur-md">
            ...
            <div className="mt-4 sm:mt-6 lg:mt-0 lg:absolute lg:-bottom-8 xl:-bottom-12 lg:left-0 lg:translate-x-0">
              <div className="bg-white/12 backdrop-blur-md rounded-xl sm:rounded-2xl p-3 sm:p-6 border border-white/22 shadow-[0_18px_60px_rgba(0,0,0,0.26)] animate-scale-in lg:animation-delay-800">
