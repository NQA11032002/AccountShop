        ...
        <div className="mx-auto mt-10 grid max-w-5xl gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {websites.map(({ name, description, href, icon: Icon, label }) => (
            <a
              ...
              aria-label={label}
              className="group rounded-2xl border border-slate-200 bg-white/80 p-5 shadow-sm transition-all hover:-translate-y-1 hover:border-violet-200 hover:shadow-lg"
            >
