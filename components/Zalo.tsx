...
export default function ZaloButton() {
    return (
        <div className="fixed right-3 bottom-4 z-[9999] flex flex-col gap-3 sm:right-5 sm:bottom-5">
            {/* Zalo */}
            <Link
                href="https://zalo.me/0389660305"
                target="_blank"
                rel="noopener noreferrer nofollow"
                className="flex h-12 w-12 items-center justify-center rounded-full z-[10000] bg-[#0068FF] shadow-lg 
            ...
            <Link
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex h-12 w-12 items-center justify-center rounded-full z-[10000] bg-[#25D366] shadow-lg 
                   animate-bounce"
            >
